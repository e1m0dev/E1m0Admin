...
ничего потому что люди сами это прекрасно делают, мне всегда приходилось как либо изменять конфиги других плагинов.

❤️ TODO.md | Был удален TODO: Сделать List message cfg для прямо дотошной кастомизации | TODO: Перенос 2.0. Причина:
Выполнен - 💚.
❤️ TODO.md | Был удален TODO: Сделать отдельный list sender в 2.0 для крутой полной настройки | TODO: Перенос 2.0.
Причина: Выполнен - 💚.
