...
public class AdminAddBlackListCommand implements CommandExecutor {
    ...
    public AdminAddBlackListCommand(E1m0Sender sender, FileConfiguration cfg, AdminsStaffService staffService, E1m0Permission permissionManager) {
        this.cfg = cfg;
        this.sender = sender;
    ...
    // /ablist E1m0 Изменил своему пиратскому братству
    @Override
