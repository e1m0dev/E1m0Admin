...
public class AdminUnBanCommand implements CommandExecutor {
    ...
    public AdminUnBanCommand(E1m0Sender sender, FileConfiguration cfg, AdminsStaffService staffService, E1m0Permission permissionManager) {
        this.cfg = cfg;
        this.sender = sender;
    ...
    public boolean onCommand(@NotNull CommandSender commandSender, @NotNull Command command, @NotNull String s, @NotNull String @NotNull [] strings) {
        ...
        if (command.getName().toLowerCase().equalsIgnoreCase("aunban")) {
            staffService.adminUnBanSystem(admin.getUniqueId(), staff.getUniqueId());
        }
